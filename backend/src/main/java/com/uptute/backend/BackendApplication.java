...
public class BackendApplication {
	...
	public CommandLineRunner demo(UserRepository accauntRepository, RoleRepository roleRepository) {
		return (args) -> {
			...
			// // accauntRepository.save(new Accaunt(new AccauntDetails("Carcaryn",
			// "Battleheart"), new UserDetails(),
			// // new TutorDetails()));
			// // accauntRepository.save(new Accaunt(new AccauntDetails("Caikahn",
			// "Mongothsbeard"), new UserDetails(),
			// // new TutorDetails()));
			// // accauntRepository.save(new Accaunt(new AccauntDetails("Therlynn",
			// "Wyvernjack"), new UserDetails(),
			// // new TutorDetails()));
			// // accauntRepository.save(new Accaunt(new AccauntDetails("Thotumal",
			// "Glimmergaunt"), new UserDetails(),
			// // new TutorDetails()));
			// // accauntRepository.save(new Accaunt(new AccauntDetails("Eilonna",
			// "Greensleeves"), new UserDetails(),
			// // new TutorDetails()));
			// // }
